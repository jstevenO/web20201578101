...
public class productoDAO implements obligacion<ProductoDTO> {
    ...
    private static final String SQL_CREATE = "INSERT INTO tb_producto (nombre_producto, descripcion_producto, unicades, valor ) VALUES(?,?,?,?)";
    ...
    public boolean create(ProductoDTO nuevo) {
        ...
        } finally { // sirve con el try-catch y la funcion es que si o si siempre hace las setencias que estan en el finally
            con.cerrarConexion();
        }
        return false;
    }
    ...
    public List<ProductoDTO> readAll() {
        ...
        try {
            ...
            lista = new ArrayList<>();
            while (rs.next()) {//rest.next = mientras exista el siguiente
